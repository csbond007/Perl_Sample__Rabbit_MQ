# This Makefile is for the EmailAlertsAnalyzer extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/EmailAlertsAnalyzer.pm]
#     AUTHOR => [q[Kaustav Saha <kaustav@>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[EmailAlertsAnalyzer]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/EmailAlertsAnalyzer.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = EmailAlertsAnalyzer
NAME_SYM = EmailAlertsAnalyzer
VERSION = 0.01
...
MAKE = make
FULLEXT = EmailAlertsAnalyzer
BASEEXT = EmailAlertsAnalyzer
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = lib/EmailAlertsAnalyzer.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/EmailAlertsAnalyzer.pm
...
DISTNAME = EmailAlertsAnalyzer
DISTVNAME = EmailAlertsAnalyzer-0.01
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/EmailAlertsAnalyzer.pm $(INST_MAN3DIR)/EmailAlertsAnalyzer.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Kaustav Saha <kaustav@>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: EmailAlertsAnalyzer' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "EmailAlertsAnalyzer",' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="EmailAlertsAnalyzer" VERSION="0.01">' > EmailAlertsAnalyzer.ppd
